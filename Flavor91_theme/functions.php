...
function thim_scripts() {
	...
	wp_localize_script( 'thim-custom-script', 'thim_custom_script',
		array( 
			'year' 		=> esc_html__( 'Year', 'thim' ),
			'month' 	=> esc_html__( 'Month', 'thim' ),
			'week' 		=> esc_html__( 'Week', 'thim' ),
			'day' 		=> esc_html__( 'Day', 'thim' ),
			'hours' 	=> esc_html__( 'Hours', 'thim' ),
			'minutes' 	=> esc_html__( 'Minutes', 'thim' ),
			'seconds' 	=> esc_html__( 'Seconds', 'thim' ),
		)
	);
}
